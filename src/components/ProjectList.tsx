...
import { Plus, Folder, Calendar, Trash2, ChevronRight, Loader2, FileText, Settings2 } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        {projects.map((project) => (
          <motion.div
            ...
            className="group bg-white rounded-2xl p-6 shadow-sleek border border-slate-200 hover:border-indigo-300 hover:shadow-indigo-50 transition-all cursor-pointer relative overflow-hidden"
          >
